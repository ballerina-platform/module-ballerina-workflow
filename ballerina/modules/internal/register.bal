...
# module initialization time for every `createHumanTask` call site found in user code,
# similar to how `registerWorkflow` is generated for `@Workflow` functions.
#
# + taskName - The task name passed to `createHumanTask`; used directly as the
