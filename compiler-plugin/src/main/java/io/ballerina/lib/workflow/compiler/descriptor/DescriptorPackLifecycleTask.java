...
/**
 * Writes the descriptor built by {@link WorkflowDescriptorBuilder} into the generated JAR as a
 * root-level {@code workflow.def.json} entry — a single fixed name, never scanned for, so the
