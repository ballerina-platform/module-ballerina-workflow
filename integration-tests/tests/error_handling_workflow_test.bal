...
function testActivityErrorHandling() returns error? {
    ...
    string workflowId1 = check workflow:startProcess(errorHandlingWorkflow, input1);
    ...
    string workflowId2 = check workflow:startProcess(errorHandlingWorkflow, input2);
